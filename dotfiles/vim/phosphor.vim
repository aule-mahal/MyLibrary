...
hi CursorLine   guifg=#001000  guibg=#008000  ctermfg=47      ctermbg=23      cterm=None
...
" Popup menu
hi Pmenu        guifg=#80ff80  guibg=#002000  ctermfg=47  ctermbg=23
hi PmenuSel     guifg=#001000  guibg=#80ff80  ctermfg=47  ctermbg=23
hi PmenuSbar    guibg=#104010
hi PmenuThumb   guibg=#40a040

" Code colors
hi Comment      guifg=#40a040                 ctermfg=72  ctermbg=bg
hi Constant     guifg=#008000                 ctermfg=46
hi Special      guifg=#30ff30                 ctermfg=76
hi Identifier   guifg=#007000                 ctermfg=2
hi Statement    guifg=#40ff40                 ctermfg=10                         gui=none
hi PreProc      guifg=#00c000                 ctermfg=28
hi Type         guifg=#30ff30                 ctermfg=46                    gui=none
